...
use cwd_hooks::Hooks;
use subdao_pre_propose_single::contract::ExecuteMsg as PreProposeMsg;
...
pub(crate) const CONTRACT_NAME: &str = "crates.io:subdao-proposal-single";
    ...
    let response = {
        if !prop.msgs.is_empty() {
            let execute_message = WasmMsg::Execute {
                ...
                msg: to_binary(&subdao_core::msg::ExecuteMsg::ExecuteProposalHook {
                    msgs: prop.msgs,
                })?,
                funds: vec![],
            };
