...
impl WasmMockQuerier {
    ...
    pub fn with_delegations(&mut self, delegations: HashMap<(String, String), Uint128>) {
        for ((delegator_addr, validator_addr), shares) in delegations {
            self.delegations
                .insert((delegator_addr, validator_addr), shares);
        }
    }
        ...
        match path {
            ...
            "/cosmos.staking.v1beta1.Query/Delegation" => {
                ...
                let response = QueryDelegationResponse {
                    delegation_response: Some(neutron_std::types::cosmos::staking::v1beta1::DelegationResponse {
                        delegation: Some(neutron_std::types::cosmos::staking::v1beta1::Delegation {
