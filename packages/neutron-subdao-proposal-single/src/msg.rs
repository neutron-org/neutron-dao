...
pub enum QueryMsg {
    /// Gets the governance module's config. Returns `types::Config`.
    #[returns(crate::types::Config)]
    Config {},
    /// Gets information about a proposal. Returns
    /// `proposals::Proposal`.
    #[returns(crate::types::ProposalResponse)]
