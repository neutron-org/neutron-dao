...
//! rules](https://github.com/cosmos/cosmos-sdk/blob/7728516abfab950dc7a9120caad4870f1f962df5/types/coin.go#L865-L867)
//! as the SDK.
//!
...
mod tests {
    ...
    fn test_validate_native_denom_invalid() {
        let invalids = [
            ...
            "ab:12🥵a".to_string(),                  // Weird unicode in non-head position.
